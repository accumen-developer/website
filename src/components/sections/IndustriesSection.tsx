...
export function IndustriesSection() {
  return (
    <section id="industries" className="relative content-center items-center bg-zinc-200 box-border gap-x-20 flex flex-col shrink-0 h-min justify-center max-w-[1200px] gap-y-20 w-full z-[1] overflow-hidden px-[18px] py-20 rounded-[20px] md:gap-x-8 md:gap-y-8 md:px-10 md:py-[100px]">
